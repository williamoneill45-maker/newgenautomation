...
export default function DocumentDownloadPanel() {
  ...
  const items: Array<{ label: string; status: BundleStatus }> = [
    { label: "01 Information Sheet (COCA)", status: bundleStatus(Boolean(matter), generated) },
    { label: "02 Information Sheet (FV)", status: bundleStatus(Boolean(matter), generated) },
    { label: "03 Confidential Address application", status: bundleStatus(Boolean(matter?.intake.applicant.isAddressConfidential), generated) },
    { label: "04 Parenting Order application", status: bundleStatus(parenting, generated) },
    { label: "05 Protection Order application", status: bundleStatus(protection, generated) },
    { label: "06 MSD Request", status: bundleStatus(Boolean(matter), generated) },
    { label: "07 Police Information Sheet", status: bundleStatus(Boolean(matter), generated) },
    { label: "08 Lawyer Certificate", status: bundleStatus(Boolean(matter), generated) },
    { label: "09 Family Violence Affidavit", status: bundleStatus(protection, generated) },
    { label: "10 Ltr to Court Confirming Legal Aid", status: bundleStatus(Boolean(matter), generated) },
    { label: "11 Ltr to Court Filing Docs", status: bundleStatus(Boolean(matter), generated) },
    { label: "12 Ltr to Court Filing DV Applications", status: bundleStatus(Boolean(matter), generated) },
    { label: "13 Ltr to MFI", status: bundleStatus(Boolean(matter), generated) },
    { label: "14 Police Email", status: bundleStatus(Boolean(matter), generated) },
    { label: "15 Confidential Address Applicant Information Sheet", status: bundleStatus(Boolean(matter?.intake.applicant.isAddressConfidential), generated) },
