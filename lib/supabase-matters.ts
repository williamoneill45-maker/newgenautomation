...
function mapRow(row: MatterRow): MatterFile {
  ...
  return {
    ...
    intake: {
      ...
      ordersSought: {
        ...(intake.ordersSought ?? {}),
        protection: intake.ordersSought?.protection ?? false,
        parenting: intake.ordersSought?.parenting ?? false,
        tenancy: intake.ordersSought?.tenancy ?? false,
        ancillaryFurniture: intake.ordersSought?.ancillaryFurniture ?? false,
      },
