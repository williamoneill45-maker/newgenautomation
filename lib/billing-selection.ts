...
export const billingWorkItems: BillingWorkItemDefinition[] = [
  ...
  { id: "32-settlement-conference", formType: "32B", group: "Conferences", label: "Settlement Conference / Round Table Meeting", category: "settlement_conference", preparationFee: 210, hearingRate: 67, requiresAttendance: true, wording: "Prep settlement conference - review affidavit evidence, advise client of format and rules of engagement for meeting, seek client's instructions and advise client of strategy for the Settlement Conference. Attendance at Settlement Conference on [billing date] from [attendance time]." },
  { id: "32-directions-conference", formType: "32B", group: "Conferences", label: "Directions Conference", category: "directions_conference", preparationFee: 140, hearingRate: 67, requiresAttendance: true, wording: "Preparing for Directions Conference, taking client's instructions, advising of procedural steps, advising of what will take place at the Conference. All correspondence and calls with Counsel and parties. Enclosed Notice of Fixture, Directions granted to advance the proceedings. Attendance at Directions Conference on [billing date] from [attendance time]." },
  { id: "32-pre-hearing-conference", formType: "32B", group: "Conferences", label: "Pre-Hearing Conference", category: "pre_hearing_conference", preparationFee: 140, hearingRate: 67, requiresAttendance: true, wording: "All correspondence and phone calls with client, court and counsel with respect to these proceedings. Advise client and instruct Counsel as to the Direction of the proceedings. Inform the Court of Direction required to advance the proceedings." },
  { id: "32-memorandum-consent", formType: "32B", group: "Consent", label: "Memorandum of Consent", category: "consent_memorandum", fixedFee: 310, wording: "The parties and Counsel have negotiated a consent memorandum to advance proceedings." },
  { id: "32-report", formType: "32B", group: "Reports", label: "Report (s 132, s 133, or Lawyer for Child)", category: "lawyer_for_child_report", fixedFee: 190, wording: "Receipt of report. Perusing report. Considering recommendations. Advising client of impact of report on proceedings." },
  { id: "32-additional-factors", formType: "32B", group: "Additional factors", label: "Additional factors", category: "additional_factors", fixedFee: 190, wording: "The Respondent is self represented and this makes negotiations very challenging and is causing delays in advancing proceedings." },
  { id: "32-defended-hearing", formType: "32B", group: "Defended hearing", label: "Defended Hearing", category: "defended_hearing", preparationFee: 160, hearingRate: 160, requiresAttendance: true, wording: "Defended Hearing - review file, prepare for defended hearing, cross examination, briefing witnesses, preparing submissions. Reporting to client. We attended at the Fixture on [billing date] from [attendance time]." },
  { id: "33-judicial-conference", formType: "33A", group: "Pre-hearing matters", label: "Judicial Conference", category: "judicial_conference", preparationFee: 140, hearingRate: 67, requiresAttendance: true, wording: "Preparing for Judicial Conference, taking client's instructions, advising of procedural steps, advising of what will take place at the Conference. All correspondence and calls with Counsel and parties. Enclosed Notice of Fixture, Directions granted to advance the proceedings. Attendance at Judicial Conference on [billing date] from [attendance time]." },
  { id: "33-pre-hearing-matters", formType: "33A", group: "Pre-hearing matters", label: "Pre-hearing matters", category: "pre_hearing_matters", fixedFee: 620, wording: "Pre-hearing matters including reviewing evidence, advising client, correspondence with parties and preparing matter for next procedural step." },
  ...
  { id: "33-defended-protection-order", formType: "33A", group: "Applications and orders", label: "Defended Protection Order", category: "defended_protection_order", fixedFee: 430, wording: "Defended protection order preparation, reviewing application and evidence, advising client, correspondence and attendance-related preparation." },
  { id: "33-judge-directions", formType: "33A", group: "Defended hearings", label: "Complying with Judge's directions", category: "complying_judges_directions", fixedFee: 190, wording: "Complying with Judge's directions, reviewing directions, completing required work, correspondence and reporting to client." },
  { id: "33-defended-hearing", formType: "33A", group: "Defended hearings", label: "Defended hearing", category: "defended_hearing", preparationFee: 160, hearingRate: 67, requiresAttendance: true, wording: "Defended hearing - review file, prepare for defended hearing, cross examination, brief witness, drafting submissions and reporting to client. Attendance at the defended hearing on [billing date] from [attendance time]." },
  { id: "33-instructing-agent", formType: "33A", group: "Agent attendances", label: "Instructing agent", category: "instructing_agent", fixedFee: 190, requiresAgentType: true, wording: "Instructing agent to attend on behalf of counsel, reviewing agent report, correspondence and reporting to client." },
...
export function createStructuredBillingRecord(input: StructuredBillingInput): BillingRecord {
  ...
  const workItems = definitions.map((item) => {
    ...
    return {
      ...
      wording: applyTokens(item.wording, details),
    };
  });
