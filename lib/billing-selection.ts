...
export const billingWorkItems: BillingWorkItemDefinition[] = [
  ...
  { id: "32-defended-hearing", managementRuleId: "defended-hearing", formType: "32B", group: "Defended hearing", label: "Defended Hearing", category: "defended_hearing", preparationFee: 160, hearingRate: 67, requiresAttendance: true, wording: "Defended Hearing - attendance at the Fixture on [billing date] from [attendance time]." },
